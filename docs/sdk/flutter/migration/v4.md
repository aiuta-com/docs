...
!!! doc "Learn how it works and how to implement it:"
    ...
    - [`OnboardingFeature` scheme](/sdk/developer/configuration/features/onboarding/index.md) 
...
!!! doc "For full context, see"
    ...
    - [`Consent` model sheme](/sdk/developer/configuration/features/consent/data.md#consent)
    - [One of `Standalone` consent configuration](/sdk/developer/configuration/features/consent/index.md) and its `dataProviders`
...
!!! doc "To understand this change, see [input image](/sdk/developer/configuration/features/image-picker/uploads-history.md#input-image) and [generated image](/sdk/developer/configuration/features/try-on/generations-history.md#generated-image) schemes and its `OwnerType`s"
